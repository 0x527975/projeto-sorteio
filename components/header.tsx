      ...
      <div className="container mx-auto px-4 h-full flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Navegação principal">
          <button
            ...
            className="text-gray-400 hover:text-white transition-colors nav-link-progress"
          >
            Home
          </button>
          <button
        ...
        <div className="flex items-center gap-4">
          <Button
            onClick={() => scrollToSection("contato")}
            className="hidden md:flex bg-gradient-to-r from-[#0180fe] to-[#00b3f1] hover:from-[#0170e0] hover:to-[#00a0d0] text-white shadow-lg shadow-[#00b3f1]/30"
          >
            Fale Conosco
          </Button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-[72px] left-0 right-0 bg-[rgba(9,9,11,0.95)] backdrop-blur-sm border-b border-[#2a2a2d]">
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-4" aria-label="Menu mobile">
            ...
            <Button
              onClick={() => scrollToSection("contato")}
              className="bg-gradient-to-r from-[#0180fe] to-[#00b3f1] hover:from-[#0170e0] hover:to-[#00a0d0] text-white shadow-lg shadow-[#00b3f1]/30 w-full mt-2"
            >
              Fale Conosco
            </Button>
          </nav>
