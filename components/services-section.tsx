...
const bonusServices = [
  {
    ...
    shortDescription:
      "Nosso principal serviço: estruturação jurídica e regulatória de operações autorizadas pela LOTEP.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Estratégia legal e preventiva para proteger bens pessoais e empresariais.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Assessoria especializada na regulamentação de sorteios e promoções.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Assessoria contábil estratégica para organização financeira e conformidade fiscal.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Estratégias focadas em aumentar vendas, escalar resultados e otimizar conversões.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Sites, sistemas e plataformas digitais totalmente personalizados.",
    fullDescription:
...
function ServiceCard({
  ...
  service: (typeof bonusServices)[0];
  index: number;
}) {
  return (
    <motion.div
    ...
    >
      <motion.div
        ...
        whileHover={{
          y: -8,
          boxShadow:
            "0 20px 40px rgba(0, 179, 241, 0.3), 0 0 30px rgba(0, 179, 241, 0.2)",
        }}
        transition={{
          duration: 0.3,
          ease: "easeOut",
      ...
      >
        <div className="p-4 sm:p-6 relative z-10">
          <div className="flex items-start justify-between mb-3 sm:mb-4">
            <div
              className={`w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-950/40 to-cyan-950/40 rounded-xl flex items-center justify-center border border-blue-900/30 transition-all duration-300 group-hover:scale-105 ${
                service.highlight
                  ? "from-cyan-950/60 to-blue-950/60 border-cyan-500/40"
                  : ""
              }`}
            >
              <service.icon
            ...
            {service.isMain && (
              <span className="px-2 sm:px-3 py-1 text-[10px] sm:text-xs font-semibold rounded-full bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 transition-all duration-300 group-hover:bg-cyan-500/30">
                Principal
              </span>
            )}
          </div>
          <h3 className="text-white font-bold text-base sm:text-lg mb-2 group-hover:text-cyan-100 transition-colors duration-200">
            {service.title}
          </h3>
          <p className="text-gray-400 text-xs sm:text-sm leading-relaxed mb-3 group-hover:text-gray-300 transition-colors duration-200">
            {service.shortDescription}
          </p>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value={`item-${index}`} className="border-none">
              <AccordionTrigger className="text-cyan-400 hover:text-cyan-300 text-xs py-2 hover:no-underline transition-colors duration-300 cursor-pointer">
                Ver mais detalhes
              </AccordionTrigger>
...
export function ServicesSection() {
  return (
    <section
      id="servicos"
      className="px-4 relative overflow-hidden scroll-smooth min-h-screen py-10 sm:py-12"
    >
        ...
        <div className="w-full flex flex-col items-center justify-center">
          ...
          >
            ...
            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">
              Complemente seu sorteio legalizado com nossos serviços
              especializados. Legalização via LOTEP é nosso serviço principal.
            </p>
          </motion.div>
